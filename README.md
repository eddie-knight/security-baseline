...
All definitions are maintained in YAML format using the [Gemara Layer 2 schema](https://github.com/ossf/gemara?tab=readme-ov-file#layer-2-controls) for tandem machine and human readability.
